...
const SettingEditProfileFormModal: FC<SettingModalFormProps<SettingEditProfileForm>> = ({ form, isModalVisible, setIsModalVisible, onSubmit }) => {
  ...
  return (
    <Modal
          ...
          title={<h2 className="text-xl font-medium">Edit Profile</h2>} showClose={false}>
          <form onSubmit={onEditProfile} onReset={onEditProfileReset} className="space-y-5 my-5 min-w-96">
            <FormField intent={"admin"}>
              <span>Full Name</span>
              <FormField.Input intent={"admin"} placeholder="Oke Chinedu"  {...form.register(
                "name",
            ...
            <FormField intent={"admin"}>
              ...
              <FormField.ErrorText error={form.formState.errors.username} {...form.register(
                "username",
            ...
            <FormField intent={"admin"}>
              ...
              <FormField.ErrorText error={form.formState.errors.email}   {...form.register(
                "email",
            ...
            <div className="flex justify-between items-center">
              <FormField.Button intent={'admin'} themeSize={'3'} themeColor={"rounded-grey"} type="reset">Cancel</FormField.Button>
              <FormField.Button intent={'admin'} themeSize={'3'} themeColor={"full-blue"}>Update Profile</FormField.Button>
            </div>
          </form>
