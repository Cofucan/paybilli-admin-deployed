    ...
    <div className='bg-light-grey'>
      <div className='mx-auto flex w-[90%] items-center justify-between'>
        ...
        <div className='w-[90vw] lg:w-[45vw]'>
          ...
          <form className='border-2 border-light-grey-500 bg-white' onSubmit={onSubmit}>
            <div className='py-5 text-center'>
              <h2 className='tracking text-2xl font-semibold text-slate-800'>Password Reset</h2>
            ...
            <FormField.Button isSubmitted={isSubmitting}>Send Verification Email</FormField.Button>
          </form>
        </div>
      </div>
    </div>
