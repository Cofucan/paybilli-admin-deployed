...
// export const walletsStats = (data?: WalletsGetStatsResponse) => [
//   { icon: TotalWallet, count: data?.total_count, label: "Total Wallets"},
//   { icon: ActiveWallet, count: data?.open_count, label: "Active Wallets"},
//   {
//     icon: FrozenWallet,
...
export const walletsTableAction = (props: WalletsTableAction): TableActionDropdownProps<{ id: number; userId: string }>["data"] => [
    {
        title: "View User",
        icon: BetDetails,
        onClick: ({ id }) => props.navigate({ to: "/users/$userId", params: { userId: id.toString() } }),
    },
    {
        title: "Freeze Wallet",
        icon: freeze,
