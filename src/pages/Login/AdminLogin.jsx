...
const AdminLogin = () => {
    ...
    async function handleSubmit(event) {
        ...
        const response = await customFetch.post("account/login/", {json: formData});
    ...
    return <div className="bg-light-white">
        <div className="flex items-center justify-between w-[95%] lg:w-[85%] mx-auto">
            ...
            <div className="w-[96vw] lg:w-[45%]">
                ...
                <div className="bg-white border border-light-grey-500 shadow">
                    ...
                    <form className=" mx-auto flex flex-col gap-6 lg:gap-8" onSubmit={handleSubmit}>
        ...
        focus:placeholder:text-sm focus:ring-blue-300 focus:border-blue-400 custom-placeholder"
                        ...
                        <div className="">
                            <button
                                className="p-5 flex justify-center items-center w-[90%] mx-auto flex-col gap-3 lg:gap-5 rounded-lg cursor-pointer text-white text-lg font-medium bg-light-blue-500 hover:bg-light-blue hover:duration-700">
                                Login
                            </button>
                        </div>
