...
const ResetNewLogin = ({navigate}) => {
    async function handleSubmit(event) {
        ...
        const response = await customFetch.post("account/set-password/", {json: formData})
            ...
            <div className="flex items-center justify-between w-[85%] mx-auto">
                ...
                <div className="w-[90vw] lg:w-[45%]">
                    ...
                    <div className="bg-white border border-light-grey-500 shadow">
                        ...
                        <form className=" mx-auto flex flex-col gap-3" onSubmit={handleSubmit}>
                  ...
                  focus:placeholder:text-sm focus:ring-blue-300 focus:border-blue-400 custom-placeholder"
                            ...
                            <div className="my-5">
                                <button
                                    className="py-5 flex justify-center items-center w-[90%] mx-auto flex-col gap-3 lg:gap-5 rounded-lg cursor-pointer text-white text-lg font-medium bg-light-blue-500 hover:bg-light-blue hover:duration-700"
                                >
                                    Update Password
                                </button>
                            </div>
