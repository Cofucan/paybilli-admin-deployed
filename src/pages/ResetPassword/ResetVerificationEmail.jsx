...
const ResetVerificationEmail = ({ navigate, setEmail }) => {
  async function handleSubmit(event) {
    event.preventDefault()
    const formData = Object.fromEntries(new FormData(event.currentTarget))
    const response = await customFetch.post('account/reset-password/', {
      json: formData,
    })
    ...
    <div className='bg-light-grey'>
      <div className='flex items-center justify-between w-[90%] mx-auto'>
        ...
        <div className='w-[90vw] lg:w-[45vw]'>
          ...
          <form
            className=' bg-white border-2 border-light-grey-500'
          ...
          >
            ...
            <div className='lg:w-[45vw] mx-auto flex flex-col gap-10'>
              ...
              <div className=''>
                <button className='p-5 bg-light-blue-500 flex justify-center w-[80vw] md:w-[40vw] mx-auto smd:mx-auto md:mx-2 lg:mx-auto rounded-lg hover:bg-[#3abdff] hover:duration-500 cursor-pointer mb-5 text-white text-lg font-medium'>
