      ...
      >
        <FormField intent={'admin'}>
          ...
          <FormField.Input
            ...
            {...register(
              'event_name',
              formErrorHelper('Bet Name', { isRequired: true, minLength: 3 }),
            )}
        ...
        <FormField intent={'admin'}>
          ...
          <FormField.Select
            ...
            {...register(
              'event_type',
              formErrorHelper('Bet Type', { isRequired: true }),
            )}
        ...
        <FormField intent={'admin'}>
          ...
          <FormField.Input
            ...
            {...register(
              'amount',
              formErrorHelper('Amount', { isRequired: true, min: 1 }),
            )}
        ...
        <FormField intent={'admin'}>
          ...
          <FormField.Select
            ...
            {...register(
              'currency',
              formErrorHelper('Currency', { isRequired: true }),
            )}
        ...
        <FormField intent={'admin'}>
          ...
          <FormField.Input
            ...
            {...register(
              'due_date',
              formErrorHelper('Due Date', { isRequired: true }),
            )}
