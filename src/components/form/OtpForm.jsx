    ...
    <div className={twMerge('flex gap-4', className)}>
      {otpValues.map((value, index) => (
        <input
          ...
          {...inputProps}
          className={twMerge(
            'w-12 h-12 text-center text-2xl font-bold border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200',
