...
export const inputVariants = cva("", {
  variants: {
    intent: {
      admin:
        "w-full px-4 py-2 border-2 border-gray-200 rounded-lg placeholder:text-sm placeholder:text-gray-400 focus:outline-none focus:border-none focus:ring-2 focus:ring-light-blue-500",
      login:
...
const FormInput = forwardRef<HTMLInputElement, InputProps>(function CustomInput(
  ...
  if (type === "password")
    return <FormInputPassword intent={intent} className={inputClassName} {...props} ref={ref} />;
