  ...
  return (
    <section>
      <div className="p-4 space-y-6">
        ...
        {/* Info Box */}
        <div className="bg-[#3faae0] bg-opacity-20 p-4 rounded-md flex items-start">
        ...
        <div className="flex justify-between items-center mt-6">
          <button
            ...
            className="bg-white border border-[#3faae0] text-[#3faae0] py-2 px-6 rounded"
          >
            Cancel
          </button>
          <button className="bg-[#3faae0] text-white py-3 px-6 rounded">
            Download Report
          </button>
        </div>
      </div>
